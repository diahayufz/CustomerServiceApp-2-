...
import com.example.customerserviceapp.databinding.ActivityMainBinding
        ...
        when (requestCode){
            LOCATION_PERMISSION_REQUEST_CODE -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "Akses Lokasi ditolak, silahkan ganti lokasi isin lokasi pengaturan", Toast.LENGTH_SHORT).show()
                }
                return
            }
        }
